...
const (
	sighashMask                 = 0x1f
	blake2BSighash              = "bitcoinzSigHash"
	prevoutsHashPersonalization = "bitcoinzPrevoutHash"
	sequenceHashPersonalization = "bitcoinzSequencHash"
	outputsHashPersonalization  = "bitcoinzOutputsHash"
...
// Params signifies the chain specific parameters of the bitcoinz network.
type Params struct {

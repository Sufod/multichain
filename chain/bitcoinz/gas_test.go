...
var _ = Describe("Gas", func() {
	Context("when estimating bitcoinz network fee", func() {
		It("should work", func() {
			...
			gasEstimator1 := bitcoinz.NewGasEstimator(client, 1, pack.NewU256FromUint64(fallback1))
			...
			gasEstimator2 := bitcoinz.NewGasEstimator(client, 10, pack.NewU256FromUint64(fallback2))
			...
			gasEstimator3 := bitcoinz.NewGasEstimator(client, 100, pack.NewU256FromUint64(fallback3))

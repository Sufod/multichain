...
// An Address represents a bitcoinz address.
type Address interface {
	btcutil.Address
	BitcoinAddress() btcutil.Address
}

// AddressPubKeyHash represents an address for P2PKH transactions for bitcoinz that
...
// AddressScriptHash represents an address for P2SH transactions for bitcoinz that
// is compatible with the Bitcoin Compat API.
...
// type that implements the bitcoinz.Address interface
